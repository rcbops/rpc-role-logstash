...
- **elsaticsearch_host**: Logstash output host for local elasticsearch services(default: localhost)
- **elsaticsearch_tcp_port**: Logstash output port for local elasticsearch services(default: 9200)
